...
enum {
	IDX_UINT32, IDX_UINT64, IDX_FIXED32, IDX_FIXED64, IDX_UENUM,
	IDX_INT32, IDX_INT64, IDX_SINT32, IDX_SINT64, IDX_SFIXED32, IDX_SFIXED64, IDX_ENUM,
	IDX_FLOAT, IDX_DOUBLE,
	IDX_BOOL,
	IDX_BYTES, IDX_FIXED_BYTES,
	IDX_STRING,
	IDX_COUNT,
};
...
{
	char *argv[IDX_COUNT] = {
		[IDX_UINT32] = "42", [IDX_UINT64] = "1", [IDX_FIXED32] = "1", [IDX_FIXED64] = "1",
		[IDX_UENUM] = "0",
		[IDX_INT32] = "not-a-number", /* malformed: aborts here */
		[IDX_INT64] = "1", [IDX_SINT32] = "1", [IDX_SINT64] = "1",
		[IDX_SFIXED32] = "1", [IDX_SFIXED64] = "1", [IDX_ENUM] = "0",
		[IDX_FLOAT] = "1", [IDX_DOUBLE] = "1",
		[IDX_BOOL] = "true",
		[IDX_BYTES] = "hAA", [IDX_FIXED_BYTES] = "hAABBCCDD",
		[IDX_STRING] = "x",
	};
	struct fixture req = FIXTURE_INIT_ZERO;
